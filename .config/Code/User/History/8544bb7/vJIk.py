...
primary_widgets = [
    *workspaces(),
    ...
    icon(fg="focus", fontsize=17, text=' 󰤨 ' ), # Icon: nf-mdi-wifi
    widget.Wlan(**base(fg='focus'), interface='wlp0s20f3', format='{essid}', padding=5, disconnected_message='Disconnected', update_interval=5),
