...
primary_widgets = [
    *workspaces(),
    ...
    icon(fg="focus", fontsize=17, text='   ' ), # Icon: nf-mdi-battery

    widget.Battery(**base(fg='focus'), format='{percent:2.0%}', padding=5, charge_char='', discharge_char='', low_percentage=0.2, low_foreground='red'),
